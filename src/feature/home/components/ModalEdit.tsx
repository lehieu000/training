...
const ModalEdit = (props: IItemHome) => {
    const { t } = useTranslation();
    const { isModalVisible, currentItem, setCurrentItem, onPressSave } = props;
    return (
        <Modal visible={isModalVisible} animationType="none" transparent={true}>
            <View style={styles.styleModal}>
                ...
                <TextInput
                    ...
                    multiline={false}
                />
                <TouchableOpacity style={styles.styleButtonModal} onPress={() => onPressSave()}>
                    <Text>{t('tab.save')}</Text>
                </TouchableOpacity>
            </View>
        </Modal>
    );
