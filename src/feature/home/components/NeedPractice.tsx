...
const NeedPractice = (props: TabProps) => {
    ...
    const getListData = () => {
        getData(pageIndex, status.NeedPractice, data, setData, setRefreshing);
    };
    ...
    const onPressSave = () => {
        ...
        editData(currentItem.title, currentItem.content, status.NeedPractice, currentItem.id);
    };
